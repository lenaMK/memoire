...
Afin de rendre cette utilisation de ces données accessible à la communauté <!--ne pas faire tout ce travail pour que ça traîne dans mon ordi personnel-->, nous avons opté pour la création d'une interface visuelle, graphique et interactive qui assiste l'exploration de la base de données. Cet instrument de recherche combine les caractéristiques et les formes de production de connaissances. de l'atlas (Didi-Huberman) - savoir visuel, montage, dimension active- et de l'éditorialisation (Vitali-Rosati) - édition à l'ère du numérique, interactivité, processus dynamique.

<!-- pratique fait partie de la théorie: découle du cadre conceptuel?! Agencement reconfigure les sens - a des effets de pouvoir, donc important à aborder par la pratique, déployer -découle du cadre conceptuel -->

Ce travail s'inscrit dans le courant des humanités numériques de par l'emphase sur la pratique et l'expérimentation dans le processus de recherche. La recherche dite classique est combinée à une pratique numérique: coder des visualisations et un prototype d'atlas numérique à partir des données de CONBAVIL. Nous explicitons la dimension numérique de ce travail à travers sa documentation assidue et par la présentation d'exemples (concrétiser un travail "invisible"ou "incompréhensible"). <!-- Si la documentation est majoritairement numérique, nous faisons l'expérience de produire un atlas imprimé en sus, puisque ce type de travail devra également trouver des solutions concernant la publication dans des revues imprimées.-->
...
--> ce à quoi on peut répondre et surtout ce à quoi ça ne répond pas
